       ...
       const sendEmail = (e) =>{
        ...
        if(contactName.value === ''|| contactEmail.value === ''|| contactProject.value === ''){
          ...
          .then (()=>{
            ...
            alert('OOPS! Some failure occured', error)
          }
          )
...
const getCurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'ri-moon-foggy-line' : 'ri-sun-line'
